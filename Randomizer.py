...
XCRandomizer.CreateMainWindow(root, MainWindow, "XCDE", XCDE.Version, "Xenoblade Chronicles DE Randomizer",XCDE.seedEntryVar, XCDE.permalinkVar, XCDE.Options.Tabs, XCDE.extraCommands, XCDE.mainFolderNames, XCDE.subFolderNames, XCDE.SeedNames.Nouns, XCDE.SeedNames.Verbs, backgroundImages=XCDE.backgrounds, extraFiles=[XCDE.TitlescreenSplash])
XCRandomizer.CreateMainWindow(root, MainWindow, "XC2", XC2.Version, "Xenoblade Chronicles 2 Randomizer", XC2.seedEntryVar, XC2.permalinkVar, XC2.Options.Tabs, XC2.extraCommands, XC2.mainFolderNames, XC2.subFolderNames, XC2.SeedNames.Nouns, XC2.SeedNames.Verbs, backgroundImages=XC2.backgrounds, extraFiles=[XC2.TitlescreenSplash])
XCRandomizer.CreateMainWindow(root, MainWindow, "XC3", XC3.Version, "Xenoblade Chronicles 3 Randomizer",XC3.seedEntryVar, XC3.permalinkVar, XC3.Options.Tabs, XC3.extraCommands, XC3.mainFolderNames, XC3.subFolderNames, XC3.SeedNames.Nouns, XC3.SeedNames.Verbs, XC3.textFolderName,extraArgs=XC3.extraArgs, backgroundImages=XC3.backgrounds)
XCRandomizer.CreateMainWindow(root, MainWindow, "XCXDE", XCXDE.Version, "Xenoblade Chronicles X DE Randomizer",XCXDE.seedEntryVar, XCXDE.permalinkVar, XCXDE.Options.Tabs, XCXDE.extraCommands, XCXDE.mainFolderNames, XCXDE.subFolderNames, XCXDE.SeedNames.Nouns, XCXDE.SeedNames.Verbs, backgroundImages=XCXDE.backgrounds)
