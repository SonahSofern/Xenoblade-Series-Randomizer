...
root.title(f"Xenoblade Chronicles Series Randomizer v{Version}")
...
XCRandomizer.CreateMainWindow(root, MainWindow, XCDE.Game, XCDE.Version, "Xenoblade Chronicles DE Randomizer",XCDE.seedEntryVar, XCDE.permalinkVar, XCDE.Options.Tabs, XCDE.extraCommands, XCDE.mainFolderNames, XCDE.subFolderNames, XCDE.SeedNames.Nouns, XCDE.SeedNames.Verbs, backgroundImages=XCDE.backgrounds, extraFiles=[XCDE.TitlescreenSplash], setupHelpDesc=lambda: XCDE.XCDEHelp())
