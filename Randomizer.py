...
MainWindow.add(XenobladeDE, text ="Xenoblade DE", image=XCRandomizer.CreateImage()) 
MainWindow.add(Xenoblade2, text ="Xenoblade 2", image=XCRandomizer.CreateImage()) 
MainWindow.add(Xenoblade3, text ="Xenoblade 3", image=XCRandomizer.CreateImage()) 
MainWindow.add(XenobladeXDE, text ="Xenoblade X DE", image=XCRandomizer.CreateImage())
