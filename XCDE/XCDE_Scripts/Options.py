...
CollectableOptions = Option("Collectables Orbs", General, "Randomizes collectables on the field into the chosen options", [lambda: FieldCollectables.FieldItems()], _hasSpinBox = True)
