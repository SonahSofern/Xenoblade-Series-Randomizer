...
permalinkButton = ttk.Button(permalinkFrame, text="Settings", command=lambda: SettingsPresets.PresetsWindow("Presets", root, defaultFont, "XCDE/SaveData", EntriesToSave + Interactables.OptionList, Game))
