...
Game = "XCXDE"
Version = "1.0.0"
JsonOutput = "./XCXDE/_internal/JsonOutputs"
...
root.title(f"Xenoblade Chronicles X DE Randomizer v{Version}")
...
if isOnefile:
    ...
    bdat_path = "./XCXDE/_internal/Toolset/bdat-toolset-win64.exe"

if isOnefile: 
    icon_path = os.path.join(sys._MEIPASS, 'Images', 'XCXDEIcon.png')
else:
    icon_path = "./XCXDE/_internal/Images/XCXDEIcon.png"
...
def ShowTitleScreenText():
    pass
    # JSONParser.ChangeJSONLine(["bdat_common_ms/MNU_title_ms.json"],[8], ["name"], f"Randomizer v{Version}", Game="XCXDE") # Change Title Version to Randomizer vX.x.x
...
# Randomize Button
RandomizeButton = ttk.Button(text='Randomize', command=(lambda: GUISettings.Randomize(root,RandomizeButton,fileEntryVar, randoProgressDisplay, bdat_path, permalinkVar, randoSeedEntry, JsonOutput, outputDirVar, Interactables.OptionList, ["common"], ["common_ms"] ,[lambda: ShowTitleScreenText()], "us" )))
