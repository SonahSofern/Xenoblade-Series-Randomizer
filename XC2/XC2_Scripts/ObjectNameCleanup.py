...
def ReassignAlphabeticalSort(): # we add some custom named items if any of the following settings are on:
    if Options.AccessoriesOption.GetState() or Options.AuxCoresOption.GetState() or Options.BladeWeaponChipsOption.GetState() or Options.CosmeticsOption.GetState() or (Options.BoostOption.GetState() and Options.BoostOption_Speed.GetState()) or Options.RaceModeOption.GetState() or Options.UMHuntOption.GetState() or Options.TornaMainOption.GetState():
