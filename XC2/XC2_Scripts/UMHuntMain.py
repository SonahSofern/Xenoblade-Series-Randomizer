...
def Description():
    ...
    RaceModeDesc.Header("General Information")
    ...
    RaceModeDesc.Tag("Random Starting Landmarks")
    ...
    RaceModeDesc.Header("Gameplay Information")
    ...
    RaceModeDesc.Text(r"Defeat those waves to warp to the credits!")
    RaceModeDesc.Header(r"Ignored Settings")
