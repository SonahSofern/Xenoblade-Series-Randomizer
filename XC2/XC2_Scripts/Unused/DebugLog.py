...
def DebugCoreCrystalAddition(ValidCrystalListIDs, CorrespondingBladeNames):
    TreasureBoxestoCheck = ['./XC2/JsonOutputs/common_gmk/ma05a_FLD_TboxPop.json', "./XC2/JsonOutputs/common_gmk/ma10a_FLD_TboxPop.json", './XC2/JsonOutputs/common_gmk/ma07a_FLD_TboxPop.json', './XC2/JsonOutputs/common_gmk/ma08a_FLD_TboxPop.json', './XC2/JsonOutputs/common_gmk/ma15a_FLD_TboxPop.json', './XC2/JsonOutputs/common_gmk/ma11a_FLD_TboxPop.json', './XC2/JsonOutputs/common_gmk/ma13a_FLD_TboxPop.json', './XC2/JsonOutputs/common_gmk/ma16a_FLD_TboxPop.json', './XC2/JsonOutputs/common_gmk/ma17a_FLD_TboxPop.json', "./XC2/JsonOutputs/common_gmk/ma18a_FLD_TboxPop.json", './XC2/JsonOutputs/common_gmk/ma20a_FLD_TboxPop.json', './XC2/JsonOutputs/common_gmk/ma21a_FLD_TboxPop.json']
    debugfileread = open(debugfilename, "r", encoding= "utf-8")
    alllines = debugfileread.readlines()
    alllines.append("\n")
...
def DebugMovespeed():
    ...
    with open("./XC2/JsonOutputs/common_ms/itm_precious.json", 'r+', encoding='utf-8') as file: # Changes name text file
        ...
        file.truncate()
        json.dump(data, file, indent=2, ensure_ascii=False)
    with open("./XC2/JsonOutputs/common_gmk/ma02a_FLD_TboxPop.json", 'r+', encoding='utf-8') as file:
        data = json.load(file)
        for row in data["rows"]:
            if row["$id"] == 209:
                row["itm1ID"] = 25249
