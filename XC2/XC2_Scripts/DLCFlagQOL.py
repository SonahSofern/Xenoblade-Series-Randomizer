...
def CreateDLCtoSetFlag(ItemName: list[str], Flag: list[int], Category: list[int] = [2], ItemID: list[int] = [0], Quantity: list[int] = [0]):
    if Options.UMHuntOption.GetState() == 0:
...
def AddMovespeedDeed():
    if Options.UMHuntOption.GetState() == 0:
        ...
        BonusMovespeed = Options.StartwithIncreasedMovespeed.GetOdds() * 10
