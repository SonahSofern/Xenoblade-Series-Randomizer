...
NormalEnemyOption_Multiply = SubOption("More Enemies", NormalEnemyOption, [lambda: Enemy.EnemyMultiplier(NormalEnemyOption_Multiply_Spinbox.GetState(), IDs.NormalMonsters)])
...
UniqueEnemyOption_Multiply = SubOption("More Enemies", UniqueEnemyOption, [lambda: Enemy.EnemyMultiplier(UniqueEnemyOption_Multiply_Spinbox.GetState(), IDs.UniqueMonsters)])
...
BossEnemyOption_Multiply = SubOption("More Enemies", BossEnemyOption, [lambda: Enemy.EnemyMultiplier(BossEnemyOption_Multiply_Spinbox.GetState(), IDs.BossMonsters)])
...
UMHuntOption_Spinbox = Spinbox(UMHuntOption, 1, 10, 1, 10, 2, "Round(s)")
...
TornaMainOption_EnemyDrops_Spinbox = SubSpinbox(TornaMainOption_EnemyDrops, default=1, min=1, max=8, increment=1, width=1, description="Items")
TornaMainOption_GroundItems = SubOption("Ground Items", TornaMainOption)
TornaMainOption_Shops = SubOption("Shops", TornaMainOption)
TornaMainOption_Shops_Spinbox = SubSpinbox(TornaMainOption_Shops, default=1, min=1, max=15, increment=1, width=2, description="Items")
TornaMainOption_SideQuests = SubOption("Side Quests", TornaMainOption)
TornaMainOption_SideQuests_Spinbox = SubSpinbox(TornaMainOption_SideQuests, default=1, min=1, max=4, increment=1, width=1, description="Items")
TornaMainOption_TreasureChests = SubOption("Treasure Chests", TornaMainOption)
TornaMainOption_TreasureChests_Spinbox = SubSpinbox(TornaMainOption_TreasureChests, default=1, min=1, max=8, increment=1, width=1, description="Items")
...
TornaAddHints_ItemHints_Spinbox = SubSpinbox(TornaAddHints_ItemHints, 1, 12, 1, 1, 2, "Hints")
TornaAddHints_LocProgHints = SubOption("Location Hints", TornaAddHints)
TornaAddHints_LocProgHints_Spinbox = SubSpinbox(TornaAddHints_LocProgHints, 1, 12, 1, 1, 2, "Hints")
...
TornaChooseCommunityReqs_Gate1Req_Spinbox = SubSpinbox(TornaChooseCommunityReqs_Gate1Req, default=0, min=0, max=2, increment=1, width=1)
TornaChooseCommunityReqs_Gate2Req = SubOption("Gate 2 Required Level", TornaChooseCommunityReqs)
TornaChooseCommunityReqs_Gate2Req_Spinbox = SubSpinbox(TornaChooseCommunityReqs_Gate2Req, default=0, min=0, max=4, increment=1, width=1)
