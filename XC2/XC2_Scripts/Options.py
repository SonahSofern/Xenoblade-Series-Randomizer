...
CommunityMembersOption_LV2 = SubOption("Level 2", CommunityMembersOption, hasSpinBox=True, spinDesc=communitySpinDesc, spinMax=16, spinDefault=2)
CommunityMembersOption_LV3 = SubOption("Level 3", CommunityMembersOption, hasSpinBox=True, spinDesc=communitySpinDesc, spinMax=32, spinDefault=3)
