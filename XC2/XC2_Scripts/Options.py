...
driverArtSpinboxDescription = "% of arts"
DriverArtsOption_AutoAttacks = SubOption("Auto Attacks", DriverArtsOption, [], _defState = False, hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_SingleReaction = SubOption("Single Reaction", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_MultipleReactions = SubOption("Multiple Reactions", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_Debuffs = SubOption("Debuffs", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_Buffs = SubOption("Buffs", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_Enhancements = SubOption("Enhancements", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_Cooldown = SubOption("Cooldown", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_Damage = SubOption("Damage", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_AnimationSpeed = SubOption("Animation Speed", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
DriverArtsOption_AOE= SubOption("AOE", DriverArtsOption, [], hasSpinBox=True, spinDesc=driverArtSpinboxDescription)
...
TornaMainOption_CollectionPoints = SubOption("Collection Points", TornaMainOption, hasSpinBox = True, spinMin = 1, spinMax = 4, spinIncr = 1, spinWidth = 1, spinDefault = 1, spinDesc = "Items")
...
TornaChooseCommunityReqs_Gate1Req = SubOption("Community Gate 1 Required Level", TornaChooseCommunityReqs, hasSpinBox = True, spinMin = 0, spinMax = 2, spinIncr = 1, spinWidth = 1, spinDefault = 0)
TornaChooseCommunityReqs_Gate2Req = SubOption("Community Gate 2 Required Level", TornaChooseCommunityReqs, hasSpinBox = True, spinMin = 0, spinMax = 4, spinIncr = 1, spinWidth = 1, spinDefault = 0)
