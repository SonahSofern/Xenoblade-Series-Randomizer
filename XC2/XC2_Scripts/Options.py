...
BladeSpecialOption = Option("Blade Specials", Blade, "Randomizes each hit of a blade special to have a random effects", [lambda:(_BladeSpecials.BladeSpecials(), _BladeSpecials.BladeEXSpecials())], _hasSpinBox = True)
