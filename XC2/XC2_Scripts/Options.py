...
BoostOption_WP = SubOption("WP Boost", BoostOption, [lambda: Helper.MathmaticalColumnAdjust(["XC2/JsonOutputs/common/BTL_Arts_Dr.json"], ["NeedWP1", "NeedWP2", "NeedWP3", "NeedWP4", "NeedWP5"], [f'row[key] // {BoostOption_WP.GetSpinbox()}'])], hasSpinBox=True, spinMin=1, spinDefault=2,spinIncr = 1, spinDesc = "x Faster")
BoostOption_Speed = SubOption("Movespeed Boost", BoostOption, [lambda: QualityOfLife.AddMovespeedDeed()], hasSpinBox = True, spinMin = 0, spinMax = 500, spinIncr = 5, spinDesc = "% Increase", spinWidth = 3, spinDefault = 150)
