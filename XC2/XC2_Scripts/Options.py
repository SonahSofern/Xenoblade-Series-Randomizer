...
DriverArtsOption_AutoAttacks = SubOption("Auto Attacks", DriverArtsOption, [], _defState = False, hasSpinBox=True)
DriverArtsOption_SingleReaction = SubOption("Single Reaction", DriverArtsOption, [], hasSpinBox=True)
DriverArtsOption_MultipleReactions = SubOption("Multiple Reactions", DriverArtsOption, [], hasSpinBox=True)
DriverArtsOption_Debuffs = SubOption("Debuffs", DriverArtsOption, [], hasSpinBox=True)
DriverArtsOption_Buffs = SubOption("Buffs", DriverArtsOption, [], hasSpinBox=True)
DriverArtsOption_Enhancements = SubOption("Enhancements", DriverArtsOption, [], hasSpinBox=True)
DriverArtsOption_Cooldown = SubOption("Cooldown", DriverArtsOption, [], hasSpinBox=True)
DriverArtsOption_Damage = SubOption("Damage", DriverArtsOption, [], hasSpinBox=True)
DriverArtsOption_AnimationSpeed = SubOption("Animation Speed", DriverArtsOption, [], hasSpinBox=True)
DriverArtsOption_AOE= SubOption("AOE", DriverArtsOption, [], hasSpinBox=True)
