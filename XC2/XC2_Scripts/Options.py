...
spinArts = "%"
DriverArtsOption_AutoAttacks = SubOption("Auto Attacks", DriverArtsOption, [], _defState = False, hasSpinBox=True, spinDesc="% of auto attacks")
DriverArtsOption_SingleReaction = SubOption("Single Reaction", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
DriverArtsOption_MultipleReactions = SubOption("Multiple Reactions", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
DriverArtsOption_Debuffs = SubOption("Debuffs", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
DriverArtsOption_Buffs = SubOption("Buffs", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
DriverArtsOption_Enhancements = SubOption("Enhancements", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
DriverArtsOption_Cooldown = SubOption("Cooldown", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
DriverArtsOption_Damage = SubOption("Damage", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
DriverArtsOption_AnimationSpeed = SubOption("Animation Speed", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
DriverArtsOption_AOE= SubOption("AOE", DriverArtsOption, [], hasSpinBox=True, spinDesc=spinArts)
