...
BladeSpecialOption = Option("Blade Specials", Blade, "Randomizes each hit of a blade special to have a random effects", [lambda:(BladeSpecials.BladeSpecials())], hasSpinBox = True, spinDefault=10)
...
PickupRangeOption = Option("Increase Pickup Range", QOL, "Increases your pickup range" , [lambda: QualityOfLife.CollectionRange()])
