...
TornaOption_EnemyDrops = Option("Torna Enemy Drops", TornaTab, "Randomizes enemy drops. Each enemy drops a number of items equal to the spinbox upon defeat." ,_hasSpinBox = True, _spinMin = 1, _spinMax = 3, _spinIncr = 1, _spinDesc = "Item(s)", _spinWidth = 1, spinDefault = 1)
TornaOption_TreasureChests = Option("Torna Treasure Chests", TornaTab, "Randomizes treasure chest contents. Each chest contains a number of rewards equal to the spinbox." ,_hasSpinBox = True, _spinMin = 1, _spinMax = 7, _spinIncr = 1, _spinDesc = "Item(s)", _spinWidth = 1, spinDefault = 1)
