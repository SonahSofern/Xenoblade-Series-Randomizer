...
InsectExecute = Enhancement("Insecticide",22, 224, [1], Baby)
BeastExecute = Enhancement("Beast KO",22, 223, [0], Baby)
BladeComboDamUp = Enhancement("Bl Combo",23,21, Large)
FusionComboDamUp = Enhancement("Fusion",24,22, Large)
...
LaunchDurationUp = Enhancement("Launch",49,50, Medium, DisTag="Launch Duration ↑")
...
HighHPDamageUp = Enhancement("Confidence",67,65, [70, 85, 90, 95], Medium, ReversePar1=True)
ReduceSpikeDamage = Enhancement("Safety",68,66, Medium)
...
RevivalHPTeammate = Enhancement("Rescue",85, 97, Large, DisTag="Revival HP↑")
...
NightAccuracy = Enhancement("Nocturnal",95, 103, Large, DisTag="Nocturnal")
...
PartyGaugeExcellentFill = Enhancement("Excellent",101, 109, Small, Description="Fills the Party Gauge on an\n\"Excellent\" Special by [ML:Enhance kind=Param1 ].")
PartyGaugeCritFill = Enhancement("Critical",102, 112, Mini, Description="Fills the Party Gauge for\neach critical hit delivered by [ML:Enhance kind=Param1].")
...
AffinityUpButtonChallenge = Enhancement("Clicky",122, 132, Medium)
MissAffinityUp = Enhancement("Feint",123, 133, Small)
DamageTakenAffinityUp = Enhancement("Empathy",124,134, Small)
...
LV1Damage = Enhancement("Lv1 ↑",135, 145,[1], Large, DisTag="Boosted Special")
LV2Damage = Enhancement("Lv2 ↑",135, 145,[2], Large)
LV3Damage = Enhancement("Lv3 ↑",135, 145,[3], Large)
LV4Damage = Enhancement("Lv4 ↑",135, 145,[4], Large)
...
LowHPRegen = Enhancement("Regenerate",181, 230, [2,4,7,12])
...
AbsorbFireBlock = Enhancement("Nl Fire",60, 238, [1], addToList=False)
AbsorbWaterBlock = Enhancement("Nl Water",60, 239, [2], addToList=False)
AbsorbWindBlock = Enhancement("Nl Wind",60, 240, [3], addToList=False)
AbsorbEarthBlock = Enhancement("Nl Earth",60, 241, [4], addToList=False)
AbsorbElectricBlock = Enhancement("Nl Electric",60, 242, [5], addToList=False)
AbsorbIceBlock = Enhancement("Nl Ice",60, 243, [6], addToList=False)
AbsorbLightBlock = Enhancement("Nl Light",60, 244, [7], addToList=False)
AbsorbDarkBlock = Enhancement("Nl Dark",60, 245, [8], addToList=False)
ReflectFireBlock = Enhancement("Rf Fire",61, 246, [1], addToList=False)
ReflectWaterBlock = Enhancement("Rf Water",61, 247, [2], addToList=False)
ReflectWindBlock = Enhancement("Rf Wind",61, 248, [3], addToList=False)
ReflectEarthBlock = Enhancement("Rf Earth",61, 249, [4], addToList=False)
ReflectElectricBlock = Enhancement("Rf Electric",61, 250, [5], addToList=False)
ReflectIceBlock = Enhancement("Rf Ice",61, 251, [6], addToList=False)
ReflectLightBlock = Enhancement("Rf Light",61, 252, [7], addToList=False)
ReflectDarkBlock = Enhancement("Rf Dark",61, 253, [8], addToList=False)
...
BurstDestroyAnotherOrb = Enhancement("Ripple",226, 283, DisTag="Orb Ripple")
HpPotChanceFor2 = Enhancement("Potted",227, 284, Medium, addToList=False)
DestroyOrbOpposingElement = Enhancement("Buster",228, 285, DisTag="Orb Buster")
TargetNearbyOrbsChainAttack = Enhancement("Splash",229, 286, Medium, DisTag="Orb Splash")
TargetDamagedNonOpposingElement = Enhancement("Focus",230, 287, DisTag="Orb Focus")
