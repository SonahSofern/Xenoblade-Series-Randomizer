...
# General Description
This program randomizes the BDAT files in all the Switch 1 Xenoblade Chronicles Games. This allows us to randomize almost anything in the games. Enemies, Equipment, Characters, Stats, etc.  
