...
AuxCores = inclRange(15001, 15406)
WeaponChips = inclRange(10001, 10060)
CoreCrystals = inclRange(45001,45057)
Accessories = inclRange(1,687)
PreciousItems = inclRange(25001, 25499)
PouchItems = inclRange(40001,40428) - ([40106, 40107, 40280, 40282, 40284, 40285, 40300, 40387] + inclRange(40350, 40363) + inclRange(40389, 40402))
ArtDebuffs = inclRange(0,35)
DriverSkillTrees = inclRange(1,270)
HitReactions = inclRange(1,14)
ButtonCombos = inclRange(1,5)

GenOption("Pouch Item Shops", TabGeneral, "Randomizes what Pouch Items appear in Pouch Item Shops", [["common/MNU_ShopNormal.json"], StartsWithHelper("DefItem", 1, 10), PouchItems, PouchItems])
GenOption("Accessory Shops", TabGeneral, "Randomizes what Accessories appear in Accessory Shops", [["common/MNU_ShopNormal.json"], StartsWithHelper("DefItem", 1, 10), Accessories, Accessories + inclRange(448,455)])
GenOption("Weapon Chip Shops", TabGeneral, "Randomizes what Weapon Chips appear in Chip Shops", [["common/MNU_ShopNormal.json"], StartsWithHelper("DefItem", 1, 10), WeaponChips, WeaponChips])
GenOption("Treasure Chests Contents", TabGeneral, "Randomizes the contents of a treasure chest", [[InsertHelper(2,1,90, "maa_FLD_TboxPop.json"), InsertHelper(3,1,8,"itmID"), PouchItems + Accessories + WeaponChips + AuxCores + CoreCrystals]])
...
GenOption("Blade Special Reactions", TabBlades, "Randomizes each hit of a blade special to have a random effect such as break, knockback etc.", [["common/BTL_Arts_Bl.json"], StartsWithHelper("ReAct", 1, 16), HitReactions, HitReactions])
...
GenOption("Blade Special Button Challenges", TabBlades, "Randomizes what button a special uses for its button challenge", [["common/MNU_BtnChallenge2.json"], StartsWithHelper("BtnType", 1, 3), ButtonCombos, ButtonCombos])

GenOption("Enemy Drops", TabEnemies, "Randomizes enemy drop tables", [["common/BTL_EnDropItem.json"], StartsWithHelper("ItemID", 1, 8), AuxCores + Accessories + WeaponChips, AuxCores + inclRange(1, 687) + inclRange(10001, 10060)])
