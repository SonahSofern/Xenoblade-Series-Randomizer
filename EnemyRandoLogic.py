...
AllEnemyDefaultLevels = Helper.FindBadValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", ["$id"], ValidEnemies, "Lv")
...
AllBossDefaultLevels = Helper.FindBadValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", ["$id"], AllBossDefaultIDs, "Lv")
...
AllQuestDefaultEnemyIDs = list(set(AllBossDefaultIDs).symmetric_difference(set(AllQuestandBossDefaultEnemyIDs)))

AllQuestEnemyDefaultLevels = Helper.FindBadValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", ["$id"], AllQuestDefaultEnemyIDs, "Lv")

AllUniqueMonsterDefaultIDs = Helper.FindSubOptionValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", "Flag", "Named", 1, "$id")
AllUniqueMonsterDefaultIDs = list(set(AllUniqueMonsterDefaultIDs) & set(ValidEnemies))

AllUniqueMonsterDefaultLevels = Helper.FindSubOptionValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", "Flag", "Named", 1, "Lv")

AllSuperbossDefaultIDs = Helper.FindBadValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", ["Lv"], Helper.inclRange(100,200), "$id")
AllSuperbossDefaultIDs = list(set(AllSuperbossDefaultIDs) & set(ValidEnemies))

AllSuperbossDefaultLevels = Helper.FindBadValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", ["$id"], AllSuperbossDefaultIDs, "Lv")
...
AllNormalEnemyDefaultLevels = Helper.FindBadValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", ["$id"], AllNormalEnemyDefaultIDs, "Lv")
    ...
    if EnemyRandoOn == True:            
        for n in range(0, len(CheckboxList)):
            if CheckboxList[n] == "Mix Enemies Between Types Box" and CheckboxStates[n].get() == True:
                ...
                LevelstoPass = Helper.FindBadValuesList("./_internal/JsonOutputs/common/CHR_EnArrange.json", ["$id"], EnemiestoPass, "Lv")
            ...
            if CheckboxList[n] == "Mix Enemies Between Types Box" and CheckboxStates[n].get() == False:
                for o in range(0, len(CheckboxList)):
                    ...
                    if EnemiestoPass: #if the list of enemies to pass is not empty
                        ...
                        ReworkedEnemyRando(DefaultEnemyIDs, RandomizedEnemyIDs)
                        EnemiestoPass = []                    
            if CheckboxList[n] == "Keep All Enemy Levels Box" and CheckboxStates[n].get() == True:
                LevelReversion(DefaultEnemyIDs, RandomizedEnemyIDs, DefaultEnemyIDs, AllEnemyDefaultLevels)
                break
            if CheckboxList[n] == "Keep Story Boss Levels Box" and CheckboxStates[n].get() == True:
                LevelReversion(DefaultEnemyIDs, RandomizedEnemyIDs, AllBossDefaultIDs, AllBossDefaultLevels)
            if CheckboxList[n] == "Keep Quest Enemy Levels Box" and CheckboxStates[n].get() == True:
