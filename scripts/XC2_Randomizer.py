...
def Options():
    ...
    # General
    GenStandardOption("Enhancements", TabGeneral, "Randomizes enhancements on accessories, weapon chips, aux cores and skill trees", ["Custom Accessories",[lambda: CustomAccessories.CreateCustomAccessories(), lambda: IDs.ValidReplacements.extend(IDs.CustomAccessoriesIds)]])
