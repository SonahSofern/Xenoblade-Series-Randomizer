...
def Options():
    ...
    GenStandardOption("Driver Arts", TabDrivers, "Randomizes effects of all driver arts", [lambda: _DriverArts.GenCustomArtDescriptions(), lambda: _DriverArts.DriverArtRandomizer(OptionDictionary)], ["Auto Attacks", [],"Reactions", [lambda: Helper.ColumnAdjust("./_internal/JsonOutputs/common/BTL_Arts_Dr.json", Helper.StartsWith("ReAct", 1,16), 0)], "Multiple Reactions", [] ,"Debuffs",[],"Buffs",[],"Cooldown", [], "Damage", [], "Enhancements", [], "Animation Speed", []], optionType = Spinbox)
