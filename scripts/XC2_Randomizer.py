...
def Options():
    ...
    # General
    GenStandardOption("Enhancements", TabGeneral, "Creates a new balance of enhancements on accessories, arts, weapon chips, aux cores and skill trees", ["Custom Accessories",[lambda: CustomAccessories.CreateCustomAccessories(), lambda: IDs.ValidReplacements.extend(IDs.CustomAccessoriesIds)]])
    ...
    GenStandardOption("Accessory Shops", TabGeneral, "Randomizes Accessories in Accessory Shops", [lambda: JSONParser.ChangeJSONFile(["common/MNU_ShopNormal.json"], Helper.StartsWith("DefItem", 1, 10), list(set(Accessories)-set([1])),[Accessories])])
    ...
    GenStandardOption("Driver Skill Trees", TabDrivers, "Randomizes driver's skill trees", [lambda: SkillTreeAdjustments.BalancingSkillTreeRando(OptionDictionary)])
