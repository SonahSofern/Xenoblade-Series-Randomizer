...
ForeSight = Enhancement("Foresight",139, 149, Small, DisTag="Foresight")
DreamOfTheFuture = Enhancement("Dream",140, 150)
ReduceEnemyBladeComboDamage = Enhancement("Blade Res",142, 151, Medium, DisTag="Blade Combo Block")
...
LowHPSpecialUp = Enhancement("Specialist",159, 169, Baby, DisTag="Boosted Special") #Uses decimals weird one not sure how it scales
...
RepeatSpecialDamage = Enhancement("Magician",182, 193, Small, DisTag="Special Up")
