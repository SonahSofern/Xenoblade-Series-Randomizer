...
class Enhance:
    ...
    def __init__(self, Enhancement, Caption = 0,  Param1 = [], Param2 = []):
        ...
        if Param1 == []:
            ...
            Param1Val = random.randrange(Param1[0],Param1[1]+1)
        else:
            Param1Val = random.randrange(Param1[0],Param1[1]+1,5)
        ...
        if Param2 == []:
            ...
            Param2Val = random.randrange(Param2[0],Param2[1]+1)
        else:
            Param2Val = random.randrange(Param2[0], Param2[1]+1,5)    
...
def CreateEnhanceObjects(Baby, Mini, Small, Medium, Large, Mega, Massive, Giga):  
    ...
    StartBattleAggro = Enhance(83, 92, [1000,8000])
...
def EnhancementsRando():
    ...
    if len(EnhanceEffectsList) == 0:
        CreateEnhanceObjects(Baby=[1,2], Mini=[1,7], Small=[10,20], Medium=[20,40], Large=[30,100], Mega=[60,200], Massive=[300,600], Giga=[1000,1700])      # Common
        CreateEnhanceObjects(Baby=[2,4], Mini=[7,14], Small=[20,35], Medium=[40,70], Large=[100,200], Mega=[200,400], Massive=[600,1000], Giga=[1700,2500])     # Rare 
        CreateEnhanceObjects(Baby=[4,5], Mini=[14,20], Small=[35,50], Medium=[70,100], Large=[200,300], Mega=[400,600], Massive=[1000,1500], Giga=[2500,3000])    # Legendary
