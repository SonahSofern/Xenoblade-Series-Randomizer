...
NormalEnemyOption_Multiply = SubOption("More Enemies", NormalEnemyOption, [lambda: Enemy.MultiplyEnemies(NormalEnemyOption_Multiply_Spinbox.GetState(), IDs.NormalMonsters)], defState=False)
NormalEnemyOption_Multiply_Spinbox = SubSpinbox(NormalEnemyOption_Multiply, min=2, max=9, increment=1, default=2, description="x Enemies")
...
UniqueEnemyOption_Multiply = SubOption("More Enemies", UniqueEnemyOption, [lambda: Enemy.MultiplyEnemies(UniqueEnemyOption_Multiply_Spinbox.GetState(), IDs.UniqueMonsters)], defState=False)
UniqueEnemyOption_Multiply_Spinbox = SubSpinbox(UniqueEnemyOption_Multiply, min=2, max=9, increment=1, default=2, description="x Enemies")
...
BossEnemyOption_Multiply = SubOption("More Enemies", BossEnemyOption, [lambda: Enemy.MultiplyEnemies(BossEnemyOption_Multiply_Spinbox.GetState(), IDs.BossMonsters)], defState=False)
BossEnemyOption_Multiply_Spinbox = SubSpinbox(BossEnemyOption_Multiply, min=2, max=9, increment=1, default=2, description="x Enemies")
